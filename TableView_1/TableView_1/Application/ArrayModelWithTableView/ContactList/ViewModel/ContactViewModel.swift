...
class ContactViewModel {
    ...
    func initContactCellData () {
        ...
        contactCells.append(ContactModel<Any>(value: ContactInfo(phone_number: "010 415 1223", contact_name: "បងក្លូរកុច",neck_name: "@kochkoch", profile_img: "contact_2", rowType: .Profile)))
        contactCells.append(ContactModel<Any>(value: ContactInfo(phone_number: "010 789 2365", contact_name: "សើចច្រើនចំរើនជ្រួញ",neck_name: "@tra", profile_img: "contact_3", rowType: .Profile)))
        contactCells.append(ContactModel<Any>(value: ContactInfo(phone_number: "010 789 2365", contact_name: "ចេញក៏ដឹងចូលក៏ដឹង",neck_name: "@honghong", profile_img: "contact_4", rowType: .Profile)))
